...
export const initViewer = (props, callback) => {
    // 拿到状态库
    ...
    Cesium.Ion.defaultAccessToken =
        'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGkiOiJjYmIzNjI5MS1lNjUwLTQ5YzAtOTEzMS1lZjEwMzFjMGQ5YzciLCJpZCI6NTYwOTgsImlhdCI6MTY2NjQ5NzYyNX0.jl0ZgsKY3cI8yKm4RRD_voSeDTaVK4GuXZXMid_oKUc'
    ...
    // console.log('加载成功', window.viewer, store.isViewer)
    return { viewer }
}
